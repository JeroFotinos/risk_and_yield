...
%     [aux,idx_fecha]=ismember(climatotal_nuevo.FECHA(d_ini_min + i),fechas_agua);
%     % fecha_fija = datetime(20220207,'ConvertFrom','YYYYMMdd');
%     % aux = climatotal_nuevo.FECHA(d_ini_min + i)==fecha_fija;
%     if aux
%         % [aux,idx_fecha]=ismember(fecha_fija,fechas_agua);
%         % fechas_agua(idx_fecha)
%         for j = 1:size(coord,1)
%             aud(coord(j,1),coord(j,2),1) = agua_obs(j,idx_fecha);
%         end
%         aud(:,:,1) = min(aut,aud(:,:,1));
%     end
...
%     figure(1), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,15),'-*'), hold on, title('aud_1')
%     figure(2), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,16),'-*'), hold on, title('aud_2')
%     figure(3), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,17),'-*'), hold on, title('aud_3')
%     figure(4), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,18),'-*'), hold on, title('aud_4')
%     
%     figure(5), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,9),'-*'), hold on, title('prec efectiva')
%     
%     figure(5), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,11),'-*'), hold on, title('perc_1')
%     figure(6), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,12),'-*'), hold on, title('perc_2')
%     figure(7), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,13),'-*'), hold on, title('perc_3')
%     figure(8), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,14),'-*'), hold on, title('drenaje')
%     
%     figure(9), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,6),'-*'), hold on, title('prof raiz')
%     
%     figure(10), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,20),'-*'), hold on, title('ceh')
%     figure(11), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,22),'-*'), hold on, title('ct')
%     
%     figure(12), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,25),'-*'), hold on, title('bimasa')
%     figure(13), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,26),'-*'), hold on, title('biomasa total')
      figure(14), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), 10*R(:,27),'-'), hold on, title('rendimiento')
%       figure(15), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,28),'-*'), hold on, title('ici')
%       figure(16), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,32),'-*'), hold on, title('ceh-pc')
%       figure(17), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), 10*R(:,33),'-*'), hold on, title('rendimiento esc')
%       figure(18), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,34),'-*'), hold on, title('FCCH')
%     figure(15), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,30),'-*'), hold on, title('dias desde siembra')
%     figure(16), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,10),'-*'), hold on, title('evaporacion')
%     figure(18), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,19),'-*'), hold on, title('pau')
%     figure(17), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), R(:,8),'-*'), hold on, title('transpiracion')
end
figure(1), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), 10*RR(1:no_days+1,28),'-b'), hold on, title('rendimiento lote 1')
drawnow
toc
end
% figure(17), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), dpv,'-*'), hold on, title('DPV')
% figure(18), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), par,'-*'), hold on, title('PAR')
% figure(19), plot(climatotal_nuevo.FECHA(d_ini_min:d_ini_min+no_days), ET0,'-*'), hold on, title('ET0')
